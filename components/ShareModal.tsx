  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="w-full max-w-[400px] rounded-xl border-none bg-[url('/assets/doc.png')] bg-cover px-5 py-7 shadow-xl sm:min-w-[500px]">
        <DialogHeader>
          <DialogTitle className="text-white text-center">Manage Your Users</DialogTitle>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button type="submit" onClick={shareDocumentHandler} className="bg-gradient-to-t text-white from-blue-600 to-blue-500 hover:bg-gradient-to-t hover:from-blue-500 hover:to-blue-400 flex h-full gap-1 px-5" disabled={loading}>
